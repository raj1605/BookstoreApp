...
public class ApiResource {
    ...
    public Category categoryByName(@PathParam("category-name") String categoryName,
        ...
        try{
            ...
            throw new ApiException("Category lookup using categoryName failed", e);
        }
    }
    ...
    public List<Book> booksByCategoryName(@PathParam("category-name") String categoryName,
        ...
        try{
            ...
            long cat_id = category.getCategoryId();
            return bookDao.findByCategoryId(cat_id);
        }
        catch(Exception e){
            throw new ApiException("Books lookup using categoryName failed", e);
        }
    }
    ...
    public OrderDetails placeOrder(OrderForm orderForm) {
        ...
        try {
            ...
            if (orderId > 0) {
                ...
                throw new ApiException.InvalidParameter("Order not successful");
            }
